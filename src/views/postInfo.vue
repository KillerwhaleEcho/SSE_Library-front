  ...
  <div class="post-info-page">
    ...
    <div class="page-body">
            ...
            <div v-if="postDetail" class="post-card">
              ...
              <div class="post-actions">
                ...
                <button
                  class="action-button"
                  type="button"
                  :class="{ disabled: favoriteProcessing }"
              ...
              <div class="post-content">
                ...
                <p v-if="!postContentBlocks.length" class="empty-content">
                  暂无正文内容
                </p>
              </div>
            </div>
      ...
      <section class="comments-section">
        ...
        <CommentSection
          v-if="postDetail && postNumericId !== null"
          source-type="post"
          :source-id="postNumericId"
          :source-data="postSourceData"
          :show-editor="true"
...
const formattedSendTime = computed(() =>
  formatDateTime(postDetail.value?.sendTime)
);
...
const favoriteLabel = computed(() =>
  favoriteJudgement.value ? "取消收藏" : "收藏帖子"
);
const favoriteIconSrc = computed(() =>
  favoriteJudgement.value ? unfavoriteIcon : favoriteIcon
);

const likeLabel = computed(() => (likeJudgement.value ? "取消点赞" : "点赞"));
const likeIconSrc = computed(() =>
  likeJudgement.value ? likedIcon : unlikedIcon
);
...
const refreshLikeJudgement = async () => {
  ...
  try {
    const response = (await getUserLikeJudgement({
      ...
      { judgement?: boolean; isLiked?: boolean; postId?: number } | boolean
    >;
    const rawJudgement =
...
watch(
  [() => userInfo.value?.userId, () => postNumericId.value],
  async () => {
